    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        ...
        If btnSave.Text = " Save Changes " Then
            ...
            Try
                ...
                'Send_Mail("aftacaawebmaster@gmail.com, pete@seagullusa.net", "aftacaawebmaster@gmail.com", "The database was changed. The reason was:" & txtReason.Text, "Database Change")
                SendMail()
