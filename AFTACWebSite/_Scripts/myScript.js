...
$(document).ready(function () {
    ...
    $('#myNederhoed').click(function () {
        $('.myArts').removeClass('block').addClass('noDisplay');
        $('#NederhoedArt').removeClass('noDisplay').addClass('block');
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#pNederhoed").offset().top
        }, 500);
    });
    ...
    $('#mySelfTemp').click(function () {
        OpenNTK('SelfTemp')
    });

    $('#myEffective').click(function () {
        OpenNTK('Effective')
    });

    $('#myOutBack').click(function () {
        OpenNTK('OutBack')
    });

    $('#myGeggus').click(function () {
        Open20YearPic('Geggus')
    });

    $('#myAnderson').click(function () {
        Open20YearPic('Anderson')
    });

    $('#myCole').click(function () {
        Open20YearPic('Cole')
    });

    $('#myStiewig').click(function () {
        Open20YearPic('Stiewig')
    });

    $('#myMiller').click(function () {
        Open20YearPic('Miller')
    });

    $('#myBrauchle').click(function () {
        Open20YearPic('Brauchle')
    });

    $('#myTracy').click(function () {
        Open20YearPic('Tracy')
    });

    //$('#myCovidVa').click(function () {
    //    $('.myArts').removeClass('block').addClass('noDisplay');
    //    $('#CovidVacArt').removeClass('noDisplay').addClass('block');
    //    $([document.documentElement, document.body]).animate({
    //        scrollTop: $("#mainHeader").offset().top
    //    }, 500);
    //});

    //$('#myCovid').click(function () {
    //    $('.myArts').removeClass('block').addClass('noDisplay');
    //    $('#myCovidArt').removeClass('noDisplay').addClass('block');
    //    $([document.documentElement, document.body]).animate({
    //        scrollTop: $("#mainHeader").offset().top
    //    }, 500);
    //});
    ...
    $('#myFun').click(function () {
        //window.open('https://www.youtube.com/watch?v=n2CLibRLQvM', '');
        //window.open('https://rumble.com/vcs90t-incredible-dust-pan-artist.html', '');
        window.open('https://www.youtube.com/embed/n2CLibRLQvM', '');    });
    ...
    $('#myTaxes').click(function () {
        $('.myArts').removeClass('block').addClass('noDisplay');
        $('#TaxPrepArt').removeClass('noDisplay').addClass('block');
        $([document.documentElement, document.body]).animate({
            scrollTop: $("#taxPara").offset().top
        }, 500);
    });

    $('#myEllingson').click(function () {
        MainPageIndex = 'recentTitle'
        OpenObit('Ellingson');
    });

    $('#myMoxley').click(function () {
        MainPageIndex = 'recentTitle'
        OpenObit('Moxley');
    });

    $('#myGate').click(function () {
        $('.myArts').removeClass('block').addClass('noDisplay');
        $('#gateClosureArt').removeClass('noDisplay').addClass('block');
    });
    ...
    $('#aprilPomo').click(function () {
        window.open('https://aftacaa.us/_Pomos/PoMo2020_04.pdf', '');
    });
    ...
    $('#meetingMinutes').click(function () {
        window.open('_Minutes/8-12-2019_Minutes.pdf', '');
    });
